...
//             if  ( sf::Keyboard::isKeyPressed(sf::Keyboard::Delete) || sf::Keyboard::isKeyPressed(sf::Keyboard::BackSpace)   && mMessagesBox[title].size() > 0) mMessagesBox[title] = mMessagesBox[title].substr(0,mMessagesBox[title].size()-1);
//        }
//    }
